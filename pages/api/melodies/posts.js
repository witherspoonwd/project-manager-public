...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!pageNum) {
      const query = "SELECT melodyID, melodyTitle, dateCreated, htmlPath FROM private_melodies ORDER BY dateCreated DESC";
      const values = [];
      ...
      const query = "SELECT melodyID, melodyTitle, dateCreated, htmlPath FROM private_melodies ORDER BY dateCreated DESC LIMIT ?, ?";
