  ...
  try {
    ...
    if (req.method === 'POST'){
      ...
      upload.single('file')(req, res, async function (err) {
        ...
        try {
          if (editID){
            const query = "UPDATE `private_sessions` SET `sessionTitle` = ?, `htmlContent` = ? WHERE sessionID= ?";
            ...
            const query = "INSERT INTO `private_sessions` (`sessionTitle`, `htmlContent`, `dateCreated`) VALUES (?, ?, ?)";
